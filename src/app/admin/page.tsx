    ...
    if (!supabaseUrl || !supabaseKey) {
      return (
        <div className="container" style={{ textAlign: 'center', marginTop: '10vh' }}>
          ...
          <p className="subtitle">Não foi possível carregar os relatórios. Verifique suas chaves na Vercel.</p>
      ...
      return (
        <div className="container" style={{ margin: '4rem auto' }}>
          <div style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--danger)' }}>
            ...
            <p>A tabela <code>test_reports</code> rejeitou a leitura.</p>
    ...
    return (
      <div className="container" style={{ margin: '4rem auto' }}>
        <div style={{ backgroundColor: '#fee2e2', padding: '2rem', borderRadius: '12px', border: '1px solid #ef4444' }}>
          <h2 style={{ color: '#ef4444', marginBottom: '1rem' }}>Erro Crítico no Servidor da Vercel!</h2>
          <p>O painel crashou tentando ler o banco de dados. Este é o erro exato que a Vercel não estava deixando você ver:</p>
          <pre style={{ marginTop: '1rem', whiteSpace: 'pre-wrap', color: '#000', fontSize: '12px' }}>{globalError?.message || String(globalError)}</pre>
          <br />
